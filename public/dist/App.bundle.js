...
function ajaxHeart(e) {
    ...
    _axios2.default.post(this.action).then(function (res) {
        var isHearted = _this.heart.classList.toggle("heart__button--hearted"); //this refers to the form tag and heart refers to the name in our store form mixin
        (0, _bling.$)('.heart-count').textContent = res.data.hearts.length;
        if (isHearted) {
            _this.heart.classList.add("heart__button--float"); //enables css animation
            setTimeout(function () {
...
function loadPlaces(map) {
    ...
    _axios2.default.get("/api/stores/near?lat=" + lat + "&lng=" + lng).then(function (res) {
        ...
        //create markers and place them in this position
        ...
        //when someone clicks on a marker, show detail
        ...
        //zoom in on the map to fit markers pefectly
...
(0, _typeAhead2.default)((0, _bling.$)(".search")); // CSS class search

(0, _map2.default)((0, _bling.$)("#map"));

var heartForms = (0, _bling.$$)("form.heart"); //$$ is query selector all
